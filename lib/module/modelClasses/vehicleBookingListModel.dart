...
class Data {
    ...
    Data({this.battery_name, this.booking_date, this.color_name, this.contact_no, this.created_at, this.customer_name, this.dealer_name, this.email, this.id, this.is_admin,this.status, this.type, this.updated_at, this.vechicle_name, this.vechicle_status});
