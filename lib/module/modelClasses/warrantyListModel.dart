class WarrantyList {
    ...
    WarrantyList({this.data, this.message, this.success});

    factory WarrantyList.fromJson(Map<String, dynamic> json) {
        return WarrantyList(
...
class Data {
    ...
    Data({this.cd, this.claim_date, this.created_at, this.customer_email, this.customer_name, this.customer_no, this.dealer_email, this.dealer_name, this.dealer_no, this.id, this.updated_at, this.vechicle_identification_num, this.vechicle_name});
