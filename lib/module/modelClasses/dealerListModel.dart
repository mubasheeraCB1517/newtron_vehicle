...
class Data {
    ...
    Data({this.address, this.battery, this.booking_date, this.color, this.contact_no, this.created_at, this.customer_name, this.dealer_name, this.email, this.gst_in, this.id, this.is_admin, this.model, this.password, this.place, this.state, this.status, this.type, this.updated_at, this.vechicle_name, this.vechicle_status});
